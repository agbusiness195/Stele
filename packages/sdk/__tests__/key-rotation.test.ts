/**
 * Tests for key rotation integration in GrithClient.
 */
...
import type { Issuer, Beneficiary } from '@grith/core';

import { GrithClient, KeyManager } from '../src/index.js';
...
describe('GrithClient key rotation', () => {
  ...
  it('covenants signed with previous key still verify during overlap period', async () => {
    ...
    const { sign } = await import('@grith/crypto');
