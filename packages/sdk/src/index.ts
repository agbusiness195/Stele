/**
 * @stele/sdk -- High-level TypeScript SDK for the Stele protocol.
 *
 * Provides a focused entry point (SteleClient) for key management, covenant
 * lifecycle, identity management, chain operations, and CCL utilities.
 *
 * For protocol-level features (breach detection, reputation, game theory, etc.),
 * see {@link @stele/protocols}.
 *
 * For enterprise features (analytics, payments, governance, etc.),
 * see {@link @stele/enterprise}.
 *
 ...
 *
 * Provides a unified, high-level API for the core Stele protocol:
