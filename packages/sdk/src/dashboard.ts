/**
 * Metrics Dashboard data model for the Kervyx protocol.
 *
...
/** Standard metrics tracked by the Kervyx protocol. */
...
/**
 * Create a pre-built standard dashboard with panels for the Kervyx protocol.
 *
