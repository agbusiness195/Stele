/**
 * Metrics Dashboard data model for the Nobulex protocol.
 *
...
/** Standard metrics tracked by the Nobulex protocol. */
...
/**
 * Create a pre-built standard dashboard with panels for the Nobulex protocol.
 *
