/**
 * JSON Schema (Draft 2020-12) for a Nobulex CovenantDocument.
 *
...
/**
 * The complete JSON Schema for a Nobulex CovenantDocument.
 *
 ...
 * ```typescript
 * import Ajv from 'ajv';
 * import { COVENANT_SCHEMA } from '@nobulex/schema';
 *
 * const ajv = new Ajv();
...
export const COVENANT_SCHEMA = {
  ...
  $id: 'https://nobulex.dev/schema/covenant-document.json',
  title: 'Nobulex Covenant Document',
  description: 'A complete, signed Nobulex Covenant document. The covenant is the fundamental unit of the Nobulex protocol — a cryptographically signed behavioral commitment between an issuer and a beneficiary.',
  type: 'object' as const,
...
export const DISCOVERY_DOCUMENT_SCHEMA = {
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  $id: 'https://nobulex.dev/schema/discovery-document.json',
  title: 'Nobulex Discovery Document',
  description: 'A platform discovery document served at /.well-known/nobulex/configuration. Enables cross-platform agent verification and protocol negotiation.',
  type: 'object' as const,
  ...
  properties: {
    ...
    protocol_versions_supported: {
      ...
      items: { type: 'string' as const },
      minItems: 1,
      description: 'Nobulex protocol versions supported',
    },
...
export const AGENT_KEY_SCHEMA = {
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  $id: 'https://nobulex.dev/schema/agent-key.json',
  title: 'Nobulex Agent Key Entry',
...
export const CCL_EVALUATION_CONTEXT_SCHEMA = {
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  $id: 'https://nobulex.dev/schema/ccl-evaluation-context.json',
