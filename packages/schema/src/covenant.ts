/**
 * JSON Schema (Draft 2020-12) for a Kervyx CovenantDocument.
 *
...
/**
 * The complete JSON Schema for a Kervyx CovenantDocument.
 *
 ...
 * ```typescript
 * import Ajv from 'ajv';
 * import { COVENANT_SCHEMA } from '@kervyx/schema';
 *
 * const ajv = new Ajv();
...
export const COVENANT_SCHEMA = {
  ...
  $id: 'https://kervyx.dev/schema/covenant-document.json',
  title: 'Kervyx Covenant Document',
  description: 'A complete, signed Kervyx Covenant document. The covenant is the fundamental unit of the Kervyx protocol — a cryptographically signed behavioral commitment between an issuer and a beneficiary.',
  type: 'object' as const,
...
export const DISCOVERY_DOCUMENT_SCHEMA = {
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  $id: 'https://kervyx.dev/schema/discovery-document.json',
  title: 'Kervyx Discovery Document',
  description: 'A platform discovery document served at /.well-known/kervyx/configuration. Enables cross-platform agent verification and protocol negotiation.',
  type: 'object' as const,
  ...
  properties: {
    ...
    protocol_versions_supported: {
      ...
      items: { type: 'string' as const },
      minItems: 1,
      description: 'Kervyx protocol versions supported',
    },
...
export const AGENT_KEY_SCHEMA = {
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  $id: 'https://kervyx.dev/schema/agent-key.json',
  title: 'Kervyx Agent Key Entry',
...
export const CCL_EVALUATION_CONTEXT_SCHEMA = {
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  $id: 'https://kervyx.dev/schema/ccl-evaluation-context.json',
