...
function makeValidDiscovery(overrides: Record<string, unknown> = {}): Record<string, unknown> {
  return {
    ...
    keys_endpoint: 'https://platform.example.com/.well-known/stele/keys',
    covenants_endpoint: 'https://platform.example.com/.well-known/stele/covenants',
...
describe('Schema Structure', () => {
  it('COVENANT_SCHEMA has correct $id and $schema', () => {
    ...
    expect(COVENANT_SCHEMA.$id).toBe('https://stele.dev/schema/covenant-document.json');
  });
  ...
  it('DISCOVERY_DOCUMENT_SCHEMA has correct structure', () => {
    ...
    expect(DISCOVERY_DOCUMENT_SCHEMA.$id).toBe('https://stele.dev/schema/discovery-document.json');
  ...
  it('AGENT_KEY_SCHEMA has correct structure', () => {
    ...
    expect(AGENT_KEY_SCHEMA.$id).toBe('https://stele.dev/schema/agent-key.json');
  ...
  it('CCL_EVALUATION_CONTEXT_SCHEMA exists and has correct structure', () => {
    ...
    expect(CCL_EVALUATION_CONTEXT_SCHEMA.$id).toBe('https://stele.dev/schema/ccl-evaluation-context.json');
