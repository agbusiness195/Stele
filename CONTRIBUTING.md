# Contributing to Kervyx

Thank you for your interest in contributing to Kervyx, the accountability primitive for
...
kervyx/
  packages/           # All 30+ packages live here
    ...
    sdk/              # High-level KervyxClient unified SDK
...
- **Explicit error types**: Use the error classes from `@kervyx/types` (`KervyxError`,
...
By contributing to Kervyx, you agree that your contributions will be licensed
