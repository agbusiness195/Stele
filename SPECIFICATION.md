# Stele Covenant Protocol Specification
...
**Agent.** An autonomous software entity capable of executing actions on external systems. In the Stele protocol, an agent is identified by an Ed25519 key pair and participates in covenants as either an issuer or a beneficiary.
...
All signatures in the Stele protocol use the Ed25519 digital signature algorithm as specified in RFC 8032.
...
**Vector A.3.2: Sign "The Stele Protocol"**

Input message: `"The Stele Protocol"`
...
```json
{
  ...
  "$id": "https://stele.dev/schema/covenant-document/1.0",
  "title": "CovenantDocument",
  "description": "A complete, signed Stele Covenant document conforming to protocol version 1.0.",
  "type": "object",
  "required": [
    "id",
    "version",
