# Kova Covenant Protocol Specification
...
**Agent.** An autonomous software entity capable of executing actions on external systems. In the Kova protocol, an agent is identified by an Ed25519 key pair and participates in covenants as either an issuer or a beneficiary.
...
All signatures in the Kova protocol use the Ed25519 digital signature algorithm as specified in RFC 8032.
...
**Vector A.3.2: Sign "The Kova Protocol"**

Input message: `"The Kova Protocol"`
